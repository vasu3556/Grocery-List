...
// CREATED ERROR MSG
const errorMsg = "<div id='alert' class='divAlert error'><span>please enter any item to add!</span></div>";
...
const showMessage = (hasItem) => {
    if (hasItem) {
        const successMsg = `<div id='alert' class='divAlert success'><span>${hasItem} Item Added Successfully!</span></div>`;
